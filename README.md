...
主要硬件包括 STM32F407、H30 IMU、MS5837-B30 压力传感器、E22-400T30D 无线模块、三星 21700-50S 电芯定制电池组、两个已安装的 Viocean T60 水平推进器、三个垂直推进器，以及直径 130 mm、长度 250 mm 的透明耐压舱。项目总预算为人民币 2,441.3 元。数量差异、备用推进器和缺失的电气资料请参见[硬件与预算说明](docs/hardware.md)。
